...
export default function TurntablePlugin({ config, api }: PluginRenderProps) {
  ...
  return (
    <div style={{ ...mainBg, minHeight: '100%' }}>
      <h2 style={{ margin: '0 0 16px', fontSize: 20, color: '#333' }}>
        转盘抽奖
      </h2>
      ...
      <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap' as const }}>
          ...
          <div style={sectionBg}>
            ...
            {resultVisible && winner && (
              <div style={{
                ...
                <div style={{ fontSize: 13, color: '#666', marginBottom: 4 }}>恭喜中奖</div>
                <div style={{
                  fontSize: 22,
                  fontWeight: 700,
                  color: winner.color
        ...
        <div style={{ flex: 1, minWidth: 320 }}>
          <div style={sectionBg}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
                  <thead>
                    <tr style={{ borderBottom: '2px solid #f0f0f0' }}>
                      <th style={{ padding: '8px 12px', textAlign: 'left' as const, color: '#666', fontWeight: 600, width: 40 }}></th>
                      <th style={{ padding: '8px 12px', textAlign: 'left' as const, color: '#666', fontWeight: 600 }}>选项名称</th>
                      <th style={{ padding: '8px 12px', textAlign: 'center' as const, color: '#666', fontWeight: 600, width: 80 }}>权重</th>
                      <th style={{ padding: '8px 12px', textAlign: 'center' as const, color: '#666', fontWeight: 600, width: 80 }}>概率</th>
                      <th style={{ padding: '8px 12px', textAlign: 'center' as const, color: '#666', fontWeight: 600, width: 100 }}>操作</th>
                    </tr>
                  </thead>
                  <tbody>
                    {items.map(item => {
                      ...
                      return (
                        <tr key={item.id} style={{ borderBottom: '1px solid #f0f0f0' }}>
                          ...
                          <td style={{ padding: '10px 12px', color: '#333' }}>{item.label}</td>
                          <td style={{ padding: '10px 12px', textAlign: 'center' as const, color: '#333' }}>{item.weight}</td>
                          <td style={{ padding: '10px 12px', textAlign: 'center' as const, color: '#666' }}>{pct}%</td>
                          <td style={{ padding: '10px 12px', textAlign: 'center' as const }}>
                            <button
            ...
            {items.length > 0 && (
              <div style={{ marginTop: 12, padding: '8px 12px', background: '#f6ffed', borderRadius: 6, fontSize: 13, color: '#52c41a' }}>
      ...
      {modalOpen && (
        ...
        >
          ...
          >
            <h3 style={{ margin: '0 0 20px', fontSize: 18, color: '#333' }}>
              {editingItem ? '编辑选项' : '添加选项'}
            </h3>

            <div style={{ marginBottom: 16 }}>
              <label style={{ display: 'block', marginBottom: 6, fontSize: 14, color: '#333', fontWeight: 500 }}>
                选项名称
              </label>
              <input
                type="text"
